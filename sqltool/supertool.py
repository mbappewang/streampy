                ...
                if len(vidsrc_dict["result"]) != 0:
                    ...
                    for y in vidsrc_dict["result"]:
                        ...
                        if imdb_seid in imdb_seid_list:
                            ...
                            imdb_record = (imdb_id,imdb_sid,imdb_seid,season,episode,play_url_1,play_url_2)
                            same_imdb_seid = 0
                            dif_imdb_seid += 1
                            sql = "INSERT INTO imdb (imdb_id,imdb_sid,imdb_seid,season,episode,play_url_1,play_url_2) VALUES (%s,%s,%s,%s,%s,%s,%s)"
                            val = imdb_record
